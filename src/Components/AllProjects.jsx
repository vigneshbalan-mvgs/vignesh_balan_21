    ...
    <div id="projects" className="bg-dark-background text-dark-text dark:bg-light-background dark:text-light-text py-20 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mt-12">
          <Link to="/" className="bg-dark-accent hover:bg-dark-accent-hover text-white font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-lg transition-all duration-300 shadow-lg transform hover:scale-105">
            Back to Home
          </Link>
        </div>
      </div>
